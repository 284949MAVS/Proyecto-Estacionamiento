      ...
      <ul class="navbar-nav me-auto mt-2 mt-lg-0">
        ...
        <li class="nav-item dropdown">
          ...
          <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
            ...
            <li><a class="dropdown-item" href="consultar_corte.php">Registrar pago</a></li>
          </ul>
        </li>
...
<div class="form-container2">
    <h1>Registro y cobro de Ticket</h1>
</div>
...
<div class="card-container">
    ...
    <div class="card" style="background-color: #f5f5f5;">
        <div class="card-body">
            ...
            <br>
            <button name="cobro" class="btn btn-success" id="cobro" data-toggle="modal" data-target="#cobroModal">Registrar cobro</button>
        </div>
    </div>
</div>
</div>
...
<div class="container text-center mt-3">
        <div class="card" style="background-color: #f5f5f5;">
            <div class="card-body">
                ...
                <p class="card-text">Comunidad Universitaria: $10 las primeras 3 horas y $5 subsecuentes</p>

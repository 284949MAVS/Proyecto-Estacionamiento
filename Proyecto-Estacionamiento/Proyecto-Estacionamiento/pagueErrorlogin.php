  ...
  <main>
    <div class="container">
      <div class="form-container">
        <h1 style="font-weight: bold;">Error Sesion no encontrada <i class="fa-solid fa-circle-check"></i></h1>
        <p>Debes iniciar sesión para acceder a esta página.</p>
        <a href="loginPague.php" class="btn btn-primary">Iniciar sesión</a>
      </div>
    </div>
